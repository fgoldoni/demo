        ...
        <main class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-xl mx-auto py-16 sm:py-24">
                <div class="text-center">
                    ...
                    <h1 class="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">{{__('Not Found')}}</h1>
                    <p class="mt-2 text-lg text-gray-500">{{__($exception->getMessage() ?: 'Forbidden')}}</p>
                </div>
                <div class="mt-12">
