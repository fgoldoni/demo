...
>
    ...
    @else
        <button {{ $attributes->except('class') }} class="flex justify-between w-full items-center space-x-1 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider group focus:outline-none focus:underline">
            <span>{{ $slot }}</span>
